...
class ForeignKeyExecutor:
    ...
    def drop(self, action: ForeignKeyDrop) -> None:
        full = construct_full_table_name(action.catalog_name, action.schema_name, action.table_name)
    ...
    def add(self, action: ForeignKeyAdd) -> None:
        src_full = construct_full_table_name(action.catalog_name, action.schema_name, action.source_table_name)
        ref_full = construct_full_table_name(action.catalog_name, action.schema_name, action.reference_table_name)
