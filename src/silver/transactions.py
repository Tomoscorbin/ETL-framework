...
transactions = DeltaTable(
    ...
    columns=[
        DeltaColumn(name="id", data_type=T.IntegerType(), is_primary_key=True, is_nullable=False),
        DeltaColumn(name="date", data_type=T.DateType(), is_nullable=False),
        DeltaColumn(name="client_id", data_type=T.IntegerType(), is_nullable=False),
        DeltaColumn(name="card_id", data_type=T.IntegerType(), is_nullable=False),
